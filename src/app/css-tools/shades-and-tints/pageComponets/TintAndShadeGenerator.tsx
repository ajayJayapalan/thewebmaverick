...
export default function TintAndShadeGenerator() {
  ...
  const toggleTextColor = () => {
    // return toggleContrast ? "#191F33" : "#EFECE3";
    setTextColor((prev: string) => {
      let value = "#191F33";
      if (["#191F33", "#EFECE3"].includes(prev)) {
        if (prev === value) {
          value = "#EFECE3";
        }
      }
          ...
          <Card className="glass-card bg-secondary/20 border-secondary/30">
            ...
            <CardContent>
              <p className="text-sm text-foreground/70">
                Use the 500 variant as your primary color, 100-300 for
                backgrounds, and 700-900 for text or emphasis.
              </p>
            </CardContent>
          </Card>
